...
class ClassificationFilter:
    ...
    def add_prediction(self, prediction):
        ...
        # If the window size is exceeded, remove the oldest prediction
...
class Track:
    ...
    def __init__(self, mean, covariance, track_id, n_init, max_age,
        ...
        self.filters = {'hat': ClassificationFilter(),
                        'vest': ClassificationFilter()
                        } 
    ...
    def update(self, kf, detection):
        ...
        self.data_dict = detection.get_data()
